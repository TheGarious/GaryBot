...
use GaryBot\Exceptions\Core\BadMethodCallException;
use GaryBot\Exceptions\Core\UnexpectedValueException;
...
use GaryBot\Messages\Conversations\InlineConversation;
...
use GaryBot\Traits\HandlesConversations;
...
class GaryBot
{
	...
	/**
	 * Retrieve the chat message. du drivers en question.. Logique dans le driver
	 *
	 * @return array
	 */
	...
	{
		try {
			// en gros ça instancie nos drivers et vérifie qu'il sont instancier correctement.
			...
			if (! $isVerificationRequest) {
				...
				// si on a pas instancier des drivers events = ?
